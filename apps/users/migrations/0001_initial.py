    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='data add time')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('nick_name', models.CharField(default='', max_length=50, verbose_name='client nickname')),
